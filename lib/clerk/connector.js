...
CouchConnector.prototype.request = function(options, callback) {
  ...
  // attach request callback handler
  if (callback) this._requestCallback(req, options, callback);

  return req;
};


CouchConnector.prototype._requestCallback = function(req, options, callback) {
  var self = this;
