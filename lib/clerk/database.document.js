...
exports.copy = function(source, target, options, callback) {
...
exports.head = function(id, options, callback) {
  ...
  if (Array.isArray(id)) {
    this.request('POST', '_all_docs', options, { keys: id }, function(err, data, res) {
    ...
    this.request('HEAD', this._escapePath(id), options, function(err, headers, res) {
      if (err) return callback(err, null, res);
...
exports.attachment = function(id, attachmentName, options) {
