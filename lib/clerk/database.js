...
Database.prototype._request = function(options, callback) {
  options.path = options.path ? this.prefix + '/' + options.path : this.prefix;
  return this.client._request(options, callback);
};
